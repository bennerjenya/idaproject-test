  ...
  <article class='product'>
    <button class='product__delete'>
      <svg width='40' height='40' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <defs>
          <filter
            id='filter0_d_4_347' x='0' y='0' width='40' height='40' filterUnits='userSpaceOnUse'
    ...
    <div class='product__content'>
      ...
      <div class='product__body'>{{ product.body }}</div>
...
export default {
  ...
  computed: {
    convertPrice() {
      // return `${this.product.price.toLocaleString('ru-RU')} руб.`;
      return `${this.product.price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ")} руб.`;
    }
  }
}
</script>
